...
public class Flock : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < startingCount; i++)
        {
            ...
            FlockAgent newAgent = Instantiate(agentPrefab, new Vector3(Random.Range(-5.0f, 6.0f), Random.Range(-2.0f, 3.7f), Random.Range(-9.0f, 9.0f)), Quaternion.Euler(Vector3.forward * Random.Range(0f, 360f)), transform);
